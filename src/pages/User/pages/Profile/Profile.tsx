...
import { axiosConfig, ls, method } from 'src/utils/helper'
...
export default function Profile() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      ls.setProfileToLS(res.data.data)
      refetch()
      toast.success(res.data.message)
    } catch (error) {
      if (axiosConfig.isAxiosUnprocessableEntityError<ErrorResponse<FormDataError>>(error)) {
          ...
          <div className='flex justify-center md:w-72 md:border-l md:border-l-gray-200'>
            <div className='flex flex-col items-center'>
              <div className='my-5 h-24 w-24'>
                <img
                  src={previewImage || method.getAvatarUrl(avatar)}
                  alt=''
