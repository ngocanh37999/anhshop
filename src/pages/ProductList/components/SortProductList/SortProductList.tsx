...
export default function SortProductList() {
  ...
  const pageSize = productsData?.data.data.pagination.page_size
  ...
  return (
    <div className='block bg-gray-300/40 py-4 px-3 sm:grid-cols-1 md:block md:grid-cols-9'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <select
            className={classNames('hidden  h-8 px-4 text-left text-sm  capitalize outline-none md:hidden lg:block', {
