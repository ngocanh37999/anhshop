...
describe('isAxiosError', () => {
  ...
  it('isAxiosError trả về boolean', () => {
    ...
    expect(axiosConfig.isAxiosError(new Error())).toBe(false)
    expect(axiosConfig.isAxiosError(new AxiosError())).toBe(true)
  })
})

describe('isAxiosUnprocessableEntityError', () => {
  it('isAxiosUnprocessableEntityError trả về boolean', () => {
    expect(axiosConfig.isAxiosUnprocessableEntityError(new Error())).toBe(false)
    expect(
      axiosConfig.isAxiosUnprocessableEntityError(
